 ...
 **/
public class LdfuSingleCrawlMonothreadEvaluation {
    ...
    private static final String fileName = "LdfuCrawlSingleMono.csv";
    ...
    public static void main(String[] args)  throws edu.kit.aifb.datafu.parser.notation3.ParseException, IOException, edu.kit.aifb.datafu.parser.sparql.ParseException {
        ...
        InputStream is = LdfuSingleCrawlMonothreadEvaluation.class.getClassLoader().getResourceAsStream(programFile);
